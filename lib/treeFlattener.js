(function (root, factory) {
    ...
    function TreeFlattener(treeWrapper, treeObserver, options) {
        ...
        var onInit = function(parent, index, item, depth) {
            ...
            var wrapper = createItemWrapper(parent, item, depth);
        ...
        var onAdd = function(parent, siblingLevelInsertIndex, newItem, stateObj) {
            ...
            var wrapper = createItemWrapper(parent, newItem, childDepth, stateObj);
    ...
    function createItemWrapper(parent, item, depth, stateObj) {
        var wrapper = {
            depth: depth,
            item: item,
            parent: parent
