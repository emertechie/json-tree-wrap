(function (root, factory) {
    ...
    function TreeFlattener(treeWrapper, treeObserver, options) {
        ...
        var onInit = function(parent, item, index, depth) {
            if (depth === 0 && !this.options.includeRoot) {
                return;
            }
            var wrapper = createItemWrapper(item, parent, depth);
        ...
        var onAdd = function(parent, siblingLevelInsertIndex, newItem) {
            ...
            var wrapper = createItemWrapper(newItem, parent, childDepth);
    ...
    function createItemWrapper(item, parent, depth) {
        return {
            depth: depth,
            item: item,
            parent: parent
