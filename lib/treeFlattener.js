(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        define(['lodash','./treeObserver.js'], factory);
    } else if (typeof exports === 'object') {
        module.exports = factory(require('lodash'), require('./treeObserver.js'));
    } else {
        root.treeFlattener = factory(root._, root.TreeObserver);
    }
}(this, function (_, TreeObserver) {
