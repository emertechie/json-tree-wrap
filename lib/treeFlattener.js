(function (root, factory) {
    ...
    function TreeFlattener(treeWrapper, treeObserver, options) {
        ...
        var onAdd = function(parent, siblingLevelInsertIndex, newItem) {
            ...
            var wrapper = createItemWrapper(parent, newItem, childDepth);
    ...
    function createItemWrapper(parent, item, depth) {
        return {
            depth: depth,
            item: item,
            parent: parent
