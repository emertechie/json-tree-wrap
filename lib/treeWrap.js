(function (root, factory) {
    ...
    function createWrapper(obj, parent, options) {
        return {
            ...
            /*addBefore: function() {
                if (!parent) {
                    throw new Error('Can\'t add before root item');
                }

                // parent.items.indexOf(obj);
            ...
            traverse: function(callback) {
                traverse(obj, 0, 0, callback);
            }
        };
    }

    function traverse(item, index, depth, callback) {
        ...
        for (var i = 0; i < children.length; i++) {
            ...
            index = traverse(child, index, depth + 1, callback);
        }
