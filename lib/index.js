(function (root, factory) {
    ...
    function createWrapper(obj, parent, options) {
        return {
            ...
            move: function(removeIndex, insertIndexOrNewParent, newParentInsertIndex) {
                ...
                if (typeof insertIndexOrNewParent === 'number') {
                    items.splice(insertIndexOrNewParent, null, removed[0]);
                    // TODO: event
                } else {
                    insertIndexOrNewParent.add(newParentInsertIndex, removed[0]);
                    // TODO: event
                }
                return this;
            },
